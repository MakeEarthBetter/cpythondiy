...
def _find_module(name, path=None):
    ...
    print("===========_find_module:", path)
    importlib.machinery.PathFinder.invalidate_caches()

    spec = importlib.machinery.PathFinder.find_spec(name, path)

    if spec is None:
        raise ImportError("No module named6 {name!r}".format(name=name), name=name)
...
class ModuleFinder:
    ...
    def find_head_package(self, parent, name):
        ...
        if parent:
            ...
            if q:
                self.msgout(4, "find_head_package ->", (q, tail))
                return q, tail
        self.msgout(4, "raise ImportError: No module named5", qname)
        raise ImportError("No module named5 " + qname)
    ...
    def load_tail(self, q, tail):
        ...
        while tail:
            ...
            if not m:
                self.msgout(4, "raise ImportError: No module named4", mname)
                raise ImportError("No module named4 " + mname)
